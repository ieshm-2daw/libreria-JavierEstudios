    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disponibilidad', models.CharField(choices=[('disponible', 'Disponible'), ('prestado', 'Prestado'), ('en_proceso', 'En proceso de prestamo')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('libroPrestado', models.ManyToManyField(to='libreria.libro')),
